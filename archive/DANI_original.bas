...
580 IFLT$=" "THENIFWD$=""THEN540ELSE730
...
790 IS=0:FC=LEN(FO$(LW,0)):IFFC>0THENFOR IE=1 TO FC STEP2:IFMID$(FO$(LW,0),IE,2)=LH$THENIS=IE:IE=FC
795 NEXTIE
...
1210 WC=ASC(MID$(PS$,WN*2-1)+" ")-32+220*(ASC(MID$(PS$,WN*2)+" ")-32)
1220 RETURN
1300 '
1310 '    reply......
1320 '    FROM> 370,540
...
1390 PRINTWD$(WC)" ";:IFPRTHENLPRINTWD$(WC)" ";
1400 GOTO1350
